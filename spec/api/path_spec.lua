...
describe("fs.path api", function()
   ...
   describe("Path:relative_to", function()
      ...
      it("should error when the first path is not absolute", function()
         assert.has_error(function()
            path.new("foo/bar"):relative_to(path.new("/foo"))
         end)
      end)
      it("should error when the second path is not absolute", function()
         assert.has_error(function()
            path.new("/foo/bar"):relative_to(path.new("foo"))
         end)
      end)
